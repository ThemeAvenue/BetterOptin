...
var DEBUG=!1;!function(o){"use strict";var e,t;"undefined"!=typeof wpbo?(e=wpbo.replace(/&quot;/g,'"'),t=o.parseJSON(e),DEBUG&&console.log(t)):t={close_overlay:!0,close_esc:!0,cookie_lifetime:"30",animation:"bounceIn",popup_id:"betterOpt",overlayOpacity:.5,overlayColor:"#000"},o(function(){var e="wpbo_"+t.popup_id,a=o(".wpbo-modal").hide(),n=a.parent(".optform");a.easyModal({top:200,overlayOpacity:t.overlay_opacity,overlayColor:t.overlay_color,overlayClose:t.close_overlay,transitionIn:"animated "+t.animation,updateZIndexOnOpen:!1,closeOnEscape:t.close_esc,closeButtonClass:".wpbo-close",onClose:function(){var a=new Date;a=a.toDateString(),a=a.split(" ").join("_"),o.cookie(e,"closed_on_"+a,{expires:t.cookie_lifetime,path:"/"})},onOpen:function(){var e={action:"wpbo_new_impression",popup_id:t.popup_id};o.post(t.ajaxurl,e),jQuery().matchHeight&&o(".wpbo-col").matchHeight(".wpbo-grid-no-gutter"),n.find("input:first").focus(),n.submit(function(){n.find("[type=submit]").prop("disabled",!0).text("Please wait...")}),a.append('<a class="wpbo-credit" href="http://betteropt.in/" target="_blank">Popup created with <strong>BetterOptin</strong></a>')}}),null==o.cookie(e)&&o(document).one("mouseleave",function(e){e.preventDefault(),a.trigger("openModal").addClass("wpbo-modal-active"),t.wiggle===!0&&o(document).on("click",'.lean-overlay:not(".wpbo-modal")',function(){a.addClass("wpbo-tada"),a.on("oanimationend animationend webkitAnimationEnd",function(){o(this).removeClass("wpbo-tada")})})}),o(".wpbo-trigger").on("click",function(o){o.preventDefault(),a.trigger("openModal").addClass("wpbo-modal-active")})})}(jQuery);