...
var DEBUG=!1;!function(o){"use strict";var e,t;"undefined"!=typeof wpbo?(e=wpbo.replace(/&quot;/g,'"'),t=o.parseJSON(e),DEBUG&&console.log(t)):t={close_overlay:!0,close_esc:!0,cookie_lifetime:"30",animation:"bounceIn",popup_id:"betterOpt",overlayOpacity:.5,overlayColor:"#000"},o(function(){var e="wpbo_"+t.popup_id,n=o(".wpbo-modal").hide(),a=n.parent(".optform");n.easyModal({top:200,overlayOpacity:t.overlay_opacity,overlayColor:t.overlay_color,overlayClose:t.close_overlay,transitionIn:"animated "+t.animation,updateZIndexOnOpen:!1,closeOnEscape:t.close_esc,closeButtonClass:".wpbo-close",onClose:function(){var n=new Date;n=n.toDateString(),n=n.split(" ").join("_"),o.cookie(e,"closed_on_"+n,{expires:t.cookie_lifetime,path:"/"})},onOpen:function(){var e={action:"wpbo_new_impression",popup_id:t.popup_id};o.post(t.ajaxurl,e),jQuery().matchHeight&&o(".wpbo-col").matchHeight(".wpbo-grid-no-gutter"),a.find("input:first").focus(),a.submit(function(){a.find("[type=submit]").prop("disabled",!0).text("Please wait...")}),n.append('<a class="wpbo-credit" href="http://betteropt.in/?utm_source=plugin&utm_medium=credit&utm_term=organic&utm_campaign=betteroptin" target="_blank">Popup created with <strong>BetterOptin</strong></a>')}}),null==o.cookie(e)&&o(document).one("mouseleave",function(e){e.preventDefault(),n.trigger("openModal").addClass("wpbo-modal-active"),t.wiggle===!0&&o(document).on("click",'.lean-overlay:not(".wpbo-modal")',function(){n.addClass("wpbo-tada"),n.on("oanimationend animationend webkitAnimationEnd",function(){o(this).removeClass("wpbo-tada")})})}),o(".wpbo-trigger").on("click",function(o){o.preventDefault(),n.trigger("openModal").addClass("wpbo-modal-active")})})}(jQuery);